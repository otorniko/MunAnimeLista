                            ...
                            ModalNavigationDrawer(
                                ...
                                NavHost(
                                    ...
                                    composable(
                                        ...
                                        val statusStr =
                                                entry.arguments?.getString("status") ?: "ALL"
                                        val tab: ListStatus? = if (statusStr == "ALL") {
                                            null
                                        } else {
                                            try {
                                                ListStatus.valueOf(statusStr)
                                            } catch (e: Exception) {
                                                null
                                            }
                                        }
                                        ...
                                        AnimeListScreen(
                                                ...
                                                onAnimeClick = { id ->
                                                    navController.navigate(
                                                            Screen.AnimeDetails.createRoute(
                                                                    id,
                                                                    Screen.AnimeList.route
                                                                                           )
                                                                          )
                                                },
                                    ...
                                    composable(
                                        ...
                                        LaunchedEffect(type) {
                                            val category = try {
                                                RankingCategory.valueOf(type.uppercase())
                                            } catch (e: Exception) {
                                                RankingCategory.ALL
                                            }
                                            viewModel.initBrowse(category)
                                        }
                                        BrowseScreen(
                                                title = title,
                                                viewModel = viewModel,
