...
package com.otorniko.munanimelista.data.model
...
@Serializable
enum class ListStatus(val label: String, val apiValue: String) {
    @SerialName("watching")
...
enum class UserListSort(val label: String, val apiValue: String) {
    LAST_UPDATED("Last Updated", "list_updated_at"),
    SCORE("Score", "list_score"),
    TITLE("Title", "anime_title"),
    START_DATE("Release Date", "anime_start_date")
}